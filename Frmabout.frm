...
Private Sub Form_Load()
    Me.Caption = "About " & App.Title & " & Media Player"
...
Function GetUser()
    ...
    ' This function uses a windows dll to query the registry
    ' automatically returning the user name
